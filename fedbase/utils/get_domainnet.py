...
dir_path = "data/DomainNet/"

# Allocate data to users
def generate_DomainNet(client_group=1, method='iid',alpha=0.5):
    ...
    print('DomainNet Done split!')
    return train_data, test_data, 'DomainNet' +'_'+ str(client_group)+'_'+ str(alpha)+'_'+ str(method)